...
Page({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '一', 'src': '../images/account.png' },
        { 'index': 1, 'menu': '二', 'src': '../images/card.png' },
        { 'index': 2, 'menu': '三', 'src': '../images/investment.png' },
        { 'index': 3, 'menu': '四', 'src': '../images/loan.png' },
        { 'index': 4, 'menu': '五', 'src': '../images/service.png' },
        { 'index': 5, 'menu': '六', 'src': '../images/transfer.png' }
      ]
    }
